    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <main className="flex items-center justify-center min-h-screen py-20">
        <div className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Terms of Service */}
          <div id="terms" className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-left">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">✅ LOGICA MARKETING – Terms of Service (Internal Use Only)</h2>
            ...
            <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">1. Purpose</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">2. Data Usage</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">3. No Posting or Content Modification</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">4. Access and Authorization</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">5. Data Storage and Security</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">7. Updates and Modifications</h3>
              <p>
