      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">LOGICA MARKETING Analytics</h1>
              <p className="text-gray-600">TikTok Corporate Account Performance Analysis</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm text-gray-500">Last Updated</p>
                <p className="text-sm font-medium text-gray-900">Today 12:30</p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <div className="text-sm text-blue-700 font-medium">Engagement Rate</div>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-2xl font-bold text-green-600 mb-1">
                {Math.round(mockTikTokData.total_views / mockTikTokData.total_videos).toLocaleString()}
              </div>
              <div className="text-sm text-green-700 font-medium">Average Views</div>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <div className="text-2xl font-bold text-purple-600 mb-1">
                {Math.round(mockTikTokData.total_likes / mockTikTokData.total_videos).toLocaleString()}
              </div>
              <div className="text-sm text-purple-700 font-medium">Average Likes</div>
            </div>
          </div>
        </div>
      </main>
