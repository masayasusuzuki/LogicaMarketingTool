        ...
        <div className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            <div className="flex justify-center">
              <Link 
                href="/auth/callback"
                className="inline-flex items-center justify-center px-8 py-4 bg-black hover:bg-gray-800 text-white font-semibold rounded-lg text-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
              >
